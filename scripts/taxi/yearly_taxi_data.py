...
TEMP_PATH = f"data/raw/{YEAR}/taxi/temp"
OUTPUT_PATH = f"data/raw/{YEAR}/taxi/yellowtaxi_tripdata_{YEAR}.parquet"

# Increased Memory
spark = SparkSession.builder \
    .appName("YearlyTaxiData") \
...
# Processing files incrementely to avoid 12 files in RAM
for month in MONTHS:
    path = f"data/raw/{YEAR}/taxi/tlc/yellow_tripdata_{YEAR}-{month}.parquet"
